                ...
                <div class="col-xl-6 col-lg-12">
                    ...
                    <div class="about-one-left-image">
                        <div class="first-order">
                            <div class="thumb-one">
                                <img src="{{asset('/assets/images/03.jpg')}}" alt="about">
                            ...
                            <div class="thumb-bottom">
                                <img src="{{asset('/assets/images/02_1.jpg')}}" alt="about">
                            </div>
                        </div>
                        <div class="second-order">
                            <img src="{{asset('/assets/images/01_1.jpg')}}" alt="about">
                    ...
                    <div class="about-inner-right-one">
                        ...
                        <div class="author-area">
                            <div class="single-author-and-info">
                                <img src="{{asset('/assets/images/01.png')}}" alt="about">
                                <div class="information">
                                    <a href="#">
