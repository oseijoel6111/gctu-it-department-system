    ...
    <div class="banner-area-one shape-move">
            ...
            <div class="row">
                            ...
                            <div class="banner-btn-author-wrapper">
                                ...
                                <div class="sm-image-wrapper">
                                    <div class="images-wrap">
                                        <img src="images/06_1.png" alt="banner">
                                        <img class="two" src="images/07.png" alt="banner">
                                        <img class="three" src="images/08.png" alt="banner">
                                    </div>
                                    <div class="info">
                ...
                <div class="col-lg-6 order--xl-2 order-lg-2 order-sm-1 order-1">
                    <div class="banner-right-img">
                        <img src="images/01_4.png" alt="banner">
                    </div>
                </div>
            </div>
        </div>
        <div class="review-thumb">
            ...
            <div class="review-single">
                <img src="images/03_1.png" alt="banner">
            ...
            <div class="review-single two">
                <img src="images/04_1.png" alt="banner">
                <div class="info-right">
                    <h6 class="title">100+
                    </h6>
        ...
        <div class="shape-image">
            <div class="shape one" data-speed="0.04" data-revert="true"><img src="images/banner-shape01.svg" alt="shape_image"></div>
            <div class="shape two" data-speed="0.04"><img src="images/banner-shape02.svg" alt="shape_image"></div>
            <div class="shape three" data-speed="0.04"><img src="images/banner-shape03.svg" alt="shape_image"></div>
        </div>
    </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="images/08_1.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="images/09.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="images/10.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="images/11.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="images/12.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="images/13.svg" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-12">
                    ...
                    <div class="about-one-left-image">
                        <div class="first-order">
                            <div class="thumb-one">
                                <img src="images/03.jpg" alt="about">
                ...
                <div class="col-xl-6 col-lg-12 pl--60 pl_lg--15 pl_md--10 pl_sm--10 pt_lg--50 pt_md--50 pt_sm--50">
                    <div class="title-area-left-style">
                        <div class="pre-title">
                            <img src="images/bulb.png" alt="icon">
                            <span>Gateway to Lifelong Learning</span>
                        </div>
                    ...
                    <div class="about-inner-right-one">
                        <div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="images/01_1.png" alt="icon-image">
                                </div>
                                <div class="information">
                            ...
                            <div class="single-facilityes">
                                <div class="icon">
                                    <img src="images/02_2.png" alt="icon-image">
                                </div>
                                <div class="information">
                        ...
                        <div class="author-area">
                            <div class="single-author-and-info">
                                <img src="images/01.png" alt="about">
                                <div class="information">
                                    <a href="#">
